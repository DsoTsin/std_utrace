...
#include "Prefix.h"
#include "Runtime/TraceLog/Public/Trace/Detail/Important/SharedBuffer.h"

#if UE_TRACE_ENABLED

#include "Runtime/TraceLog/Public/Trace/Detail/Atomic.h"
#include "Runtime/TraceLog/Public/Trace/Detail/Important/ImportantLogScope.inl"
...
////////////////////////////////////////////////////////////////////////////////
static FSharedBuffer	GNullSharedBuffer	= { 0, FSharedBuffer::RefInit, 0, 0, nullptr };
...
FNextSharedBuffer Writer_NextSharedBuffer(FSharedBuffer* Buffer, int32 RegionStart, int32 NegSizeAndRef)
{
	...
	while (true)
	{
		...
		if (UT_LIKELY(RegionStart + NegSizeAndRef >= 0))
		{
			break;
		}
...
static void Writer_RetireSharedBuffer()
{
	...
	for (;; PlatformYield())
	{
		...
		if (UT_LIKELY(((TailCursor + 1) & FSharedBuffer::RefInit) == 0))
		{
			break;
		}
	}
